          ...
          <div>
            <div className="p-6">
              ...
              <div className="mb-4">
                ...
                {
                  myData.slot.map(currentSlot => {
                    return (

                      // buji nai
                      <>
                      <Link to={`/trainerBookedPage/${myData._id}/${currentSlot}`}>
                        <p className="bg-purple-600 text-white w-full" >Available Slot : {myData.slot.length} <br />{currentSlot}</p>
                      </Link>
                      </>
                      // ai porjonto
                    )
